...
# --- Tool Class for backward compatibility ---

class PaymentTools:
    """Wrapper class to maintain compatibility with existing code."""
    
    @staticmethod
    def process_standard_payment(customer_id: str, amount: float, payment_method: str, details: dict) -> str:
        """Wrapper for the tool function."""
        return process_standard_payment.func(customer_id, amount, payment_method, details)
    
    @staticmethod
    def generate_kiosk_to_mobile_handoff(customer_id: str, amount: float, session_id: str) -> str:
        """Wrapper for the tool function."""
        return generate_kiosk_to_mobile_handoff.func(customer_id, amount, session_id)
    
    @staticmethod
    def debit_loyalty_points(customer_id: str, points_to_debit: int) -> str:
        """Wrapper for the tool function."""
        return debit_loyalty_points.func(customer_id, points_to_debit)
