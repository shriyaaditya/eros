...
from whatsapp.models import AuthState, SessionInfo, AuthFlowContext
...
# Global database instance: Redis (if REDIS_URL) -> PostgreSQL -> in-memory
db = None

if os.getenv("REDIS_URL") or os.getenv("REDIS_HOST"):
    try:
        from whatsapp.redis_store import WhatsAppRedisStore
        _pg = None
        try:
